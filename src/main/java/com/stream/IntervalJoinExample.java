...
public class IntervalJoinExample {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<Event> clickStream = env.fromElements(
                ...
                new Event("Alice", "./prod?id=300", 12000L),
        ...
        orderStream.keyBy(data->data.f0)
                ...
                .process(new ProcessJoinFunction<Tuple3<String, String, Long>, Event, Object>() {
                    @Override
                    public void processElement(Tuple3<String, String, Long> stringStringLongTuple3, Event event, ProcessJoinFunction<Tuple3<String, String, Long>, Event, Object>.Context context, Collector<Object> collector) throws Exception {
